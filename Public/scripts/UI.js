...
function scrollMenu(p, r) {
  ...
  new clickText(createVector(p.x + 130, p.y - 20, p.z), r, 70, "Search:", function() {
  }, false, false).display();

  
  new textField(createVector(p.x + 450, p.y - 20, p.z), r, 70, "enter text...", searchText, function() {
    focusedSearchbar = this.focused;  
  }, function(){
    focusedSearchbar = this.focused;
  }, true, false, focusedSearchbar).display();
}
